...
if __name__ == "__main__":
    ...
    params['pre_train'] = False #if True, please specify the path of the pretrained model
    params['model_path'] = ''
        ...
        for hs in [16, 16]:
            for rl_r in [0.3]:
                for trace_decay in [0.99]:
                    deeproute_params = {'model': model, 'hidden_size': hs, 'max_task_num': 25, 'rl_ratio':rl_r, 'trace_decay': trace_decay}
